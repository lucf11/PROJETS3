        ...
        foreach($tab_v as $value){
            ...
            foreach($tab_Aggreg as $Aggreg){//au sein de l'étudiant on boucle sur toutes les aggregs
                ...
                if($tab_listeModules == false){
                    ...
                    $note = ModelAggreg::calculerNote($Aggreg,$value);//calcul de la note de l'étudiant sur cet aggreg
                    var_dump($note);
                    $avis = ModelAggreg::produireAvis($Aggreg,$note);//méthode produisant un avis sur l'aggregation
                    ...
                    var_dump($moyenne);
                    $avis = ModelAggreg::produireAvis($Aggreg,$moyenne);//méthode produisant un avis sur l'aggregation
                    //var_dump($avis);
                    echo $avis;//on affiche pour chaque aggreg l'avis de l'ordinateur 
                }         
            }
